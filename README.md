...
*    --probability_map: Save probability map that is generated by the ensemble network
*    --lesion_threshold: Define the minimum lesion volume, all lesions that are smaller will not be segmented
